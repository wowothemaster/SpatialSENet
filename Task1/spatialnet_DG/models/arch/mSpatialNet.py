...
class mSpatialNetLayer(nn.Module):
    ...
    def __init__(
        ...
        self.mhsa = Mamba(d_model=dim_hidden, d_state=16, d_conv=4, layer_idx=0)
...
if __name__ == '__main__':
    # CUDA_VISIBLE_DEVICES=5, python -m models.arch.mSpatialNet
    x = torch.randn((2, 129, 251, 256))  # 251 = 4 second; 129 = 8 kHz; 257 = 16 kHz
    spatialnet_small = mSpatialNet(
        dim_input=256,
        dim_output=2,
        num_layers=8,
        dim_hidden=96,
