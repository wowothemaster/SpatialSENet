...
def complex_mul(noisy, mask):
    noisy_r, noisy_i = noisy.real, noisy.imag
    mask_r, mask_i = mask.real, mask.imag

    enhanced_r = noisy_r * mask_r - noisy_i * mask_i
    enhanced_i = noisy_r * mask_i + noisy_i * mask_r
    return torch.complex(enhanced_r, enhanced_i)
